const COCKTAILS = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "Gros glaçons + graines de grenade",
    ],
    steps: [
      "Remplissez le verre de gros glaçons.",
      "Versez le rhum et le citron vert.",
      "Complétez de ginger beer.",
      "Décorez de graines de grenade.",
    ],
...
const SPIRITS = [
  ...
  {
    id: "whisky-2b-double-malt",
    kind: "spirit",
    name: "Whisky 2B Double Malt",
    family: "Whisky · Bear Brothers",
    tagline: "Whisky bio affiné en fûts de vin blanc, nez élégant et bouche ample.",
    short: "Whisky bio · France · 46°",
    degree: "46°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> soyeuse, riche, notes de vin blanc et de bois",
      "<strong>Finale :</strong> élégante, boisée, belle maturité",
    ],
    service: [
      "À déguster pur à température ambiante (18-20 °C).",
      "Quelques gouttes d’eau fraîche ou sur gros glaçon pour l’aérer.",
      "À éviter en cocktail pour préserver ses arômes boisés uniques.",
    ],
  },
  {
    id: "vodka-clementina",
    kind: "spirit",
    name: "Vodka Clémentina",
    family: "Vodka · Bear Brothers",
    tagline: "Vodka bio à la clémentine de Corse, fraîche et fruitée.",
    short: "Vodka bio · Clémentine · 41°",
    degree: "41°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> fraîche et citronnée, ronde et fruitée",
      "<strong>Finale :</strong> clémentine légère, pointe de poivre Timut",
    ],
    service: [
      "Bien fraîche (4 à 6 °C), pure ou sur glace.",
      "En cocktails : vodka tonic clémentine, cosmopolitan revisité.",
      "Parfaite à l’apéritif.",
    ],
  },
  {
    id: "gin-bb9",
    kind: "spirit",
    name: "Gin BB9",
    family: "Gin · Bear Brothers",
    tagline: "London Dry Gin bio à la bergamote, rond, épicé et complexe.",
    short: "Gin bio · Bergamote · 41°",
    degree: "41°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> ronde, épicée, genièvre bien présent",
      "<strong>Finale :</strong> chaleur du Timut, fraîcheur bergamote",
    ],
    service: [
      "En Gin Tonic : 5 cl de BB9 + tonic + citron vert.",
      "Servi frais avec un zeste de bergamote.",
      "Aussi en Last Word ou en Spritz Bergamote.",
    ],
  },
  {
    ...
    family: "Rhum · Venezuela",
    tagline: "Assemblage de rhums vieillis jusqu’à 8 ans, rond et gourmand.",
    short: "Rhum · Venezuela · 40°",
    degree: "40°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> complexe et équilibrée, bois et vanille",
      "<strong>Finale :</strong> harmonieuse, légèrement sèche",
    ],
    service: [
      "À déguster sec à température ambiante.",
      "Avec 2 gros glaçons pour l’adoucir.",
      "Parfait en digestif.",
    ],
  },
  {
    id: "savanna-12-ans",
    kind: "spirit",
    name: "Savanna 12 ans Bapt'Clems",
    family: "Rhum · La Réunion",
    tagline: "12 ans en fûts ex-Cognac, intense et typé.",
    short: "Rhum · Réunion · 12 ans",
    degree: "45°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> souple, tanins ronds, fin épicée",
      "<strong>Finale :</strong> poivre vert, piment doux",
    ],
    service: [
      "À déguster sec pour toute sa complexité.",
      "Quelques gouttes d’eau pour l’ouvrir.",
      "Pour amateurs de rhums de caractère.",
    ],
  },
  {
    id: "bushmills-caribbean",
    kind: "spirit",
    name: "Bushmills Caribbean Cask",
    family: "Whisky · Irlande",
    tagline: "Whisky irlandais fini en fûts de rhum, doux et tropical.",
    short: "Whisky · Irlande · 40°",
    degree: "40°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> maltée, douceur de fruits tropicaux",
      "<strong>Finale :</strong> douce, épices et note de rhum",
    ],
    service: [
      "Sec ou sur gros glaçon.",
      "Belle porte d’entrée aux whiskys finis au rhum.",
      "Aussi en soirée détente.",
    ],
  },
  {
    id: "phraya-gold",
    kind: "spirit",
    name: "Phraya Gold",
    family: "Rhum · Thaïlande",
    tagline: "Rhum de luxe vieilli 7 à 12 ans, vanille et crème brûlée.",
    short: "Rhum · Thaïlande · 40°",
    degree: "40°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> crème brûlée, caramel, ananas frais",
      "<strong>Finale :</strong> douce, clous de girofle",
    ],
    service: [
      "À déguster sec pour ses arômes exotiques.",
      "Sur glace en digestif.",
      "Sublime aussi les cocktails.",
    ],
  },
  {
    id: "botran-ki",
    kind: "spirit",
    name: "Botran Ki'",
    family: "Rhum · Guatemala",
    tagline: "Solera 6 à 9 ans, miel, caramel et fruits confits.",
    short: "Rhum · Guatemala · 40°",
    degree: "40°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> confiture de fruits rouges, chêne grillé",
      "<strong>Finale :</strong> douce et enveloppante",
    ],
    service: [
      "À déguster sec, vieilli à 2300 m d’altitude.",
      "Avec 2 gros glaçons en digestif.",
      "Un rhum hors d’âge envoûtant.",
    ],
  },
  {
    id: "pacto-navio",
    kind: "spirit",
    name: "Pacto Navio Red Wine Cask",
    family: "Rhum · Cuba",
    tagline: "Rhum cubain fini en fûts de vin rouge, teinte grenat.",
    short: "Rhum · Cuba · 40°",
    degree: "40°",
    ...
    profile: [
      ...
      "<strong>Bouche :</strong> fruits secs et caramel, très ronde",
      "<strong>Finale :</strong> gourmande, crème brûlée",
    ],
    service: [
      "À déguster sec pour sa rondeur cubaine.",
      "Sur glace pour adoucir.",
      "Édition finie en Rioja, à découvrir.",
    ],
  },
];
